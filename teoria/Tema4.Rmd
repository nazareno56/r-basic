...
## Añadir un pie de foto a una grafico en una chunks

```{r, fig.height = 4, fig.cap = "Pie de grafico", fig.align = "center", fig.otras}```
```{r,echo=FALSE,fig.height = 4, fig.width = 7, fig.align = "center", fig.cap="Notas de alumnos"}
alumnos = c(1:10)
notas = c(2,5,7,9,8,3,5,6,10,7)
plot(alumnos,notas)
```

## Representar una funcion f(x)
...
- `abline(h=0:n, v=0:n, lty = "dotte, cold = "grey` Añadir una grilla al grafico
