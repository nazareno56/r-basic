...
```
De no hacer as.vector tambien entariamos incluyendo los nombres de los niveles
...
# col 1 y 3 corresponden a anchura y longitudes de petalos
# irir$Species agrupo por especies
```
Resultado en summary.html
